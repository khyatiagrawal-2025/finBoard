        ...
        {showManualEntry && (
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              ...
              <button
                type="submit"
                className="rounded-xl bg-[#FF6B00] px-7 py-3 font-black uppercase tracking-wide text-black transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_16px_rgba(255,107,0,0.18)] active:scale-95"
              >
                Add Transaction
              </button>
